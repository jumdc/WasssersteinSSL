...
collapse_level = [0, 0.20, 0.40, 0.60, 0.80, 0.99]
N = 20000

wasserstein_distance_200 = []
wasserstein_distance_500 = []
wasserstein_distance_1000 = []
...
for level in collapse_level:
    ...
    wasserstein_distance_200.append(wasserstein_distance)
    ...
    uniformity = uniform_loss(B)
    wasserstein_distance = calc_wasserstein_distance(B)
    wasserstein_distance_500.append(wasserstein_distance)
    ...
    uniformity = uniform_loss(B)
    wasserstein_distance = calc_wasserstein_distance(B)
    wasserstein_distance_1000.append(wasserstein_distance)
    print("1000 uniformity:", uniformity)
    print("1000 wasserstein_distance:", wasserstein_distance)

print("collapse level", collapse_level)
print("wasserstein_distance_200:", wasserstein_distance_200)
print("wasserstein_distance_500:", wasserstein_distance_500)
print("wasserstein_distance_1000:", wasserstein_distance_1000)